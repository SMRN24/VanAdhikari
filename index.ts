...
// AI integration note: the review endpoint is intentionally server-side so
// Forge credentials never reach the browser. The deterministic rules remain
// visible beside the generated brief for human verification.
